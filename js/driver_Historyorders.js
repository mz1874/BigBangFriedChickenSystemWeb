$(document).ready(function () {
    ...
    function selectAllOrders(page) {
        ...
        AjaxHelper.sendGet("http://bugcreator.org.cn:5000/order/byDriverId", dataTosend).then(success => {
    ...
    $('body').on("click", "#operation", function () {
        ...
        AjaxHelper.sendPost("http://bugcreator.org.cn:5000/order/updateStatus", dataTosend).then(success => {
